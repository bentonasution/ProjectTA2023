...
@section('contents')
<form action="{{ isset($transaksi) ? route('transaksidipesan.tambah.update', $transaksi->id) : route('transaksidipesan.tambah.simpan') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nomor_peminjaman" name="nomor_peminjaman" value="{{ $nomorPeminjaman }}" readonly>
                        </div>
                            <div class="form-group">
